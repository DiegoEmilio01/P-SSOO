...
static char
  ...
  *x_admin_start = "\e[1;32mBienvenido al juego! Tu eres admin\n",
  *x_member_start = "\e[1;33mBienvenido al juego!\n",
  *x_admin_req_monster = "\e[1;33m¿Deseas que haya un mounstro?\n \e[0m[1]>Si\n [2]>No\n",
  *x_admin_req_monster_succ = "Se decidió que haya mounstro\n",
  *x_admin_req_monster_fail = "Se decidió que NO haya mounstro\n",
  *x_req_char_err = "\e[1;31mpcion incorrecta, \e[0mrecuerda que debe ser entre %i y %i, inclusive\n",
  *x_req_nombre = "\e[1;33mA continuación, ingresa tu nombre. Se truncará a 12 caracteres\n",
  *x_req_class = "\e[1;33m¿Qué clases deseas ser?\n \e[0m[0]>Cazador\n [1]>Médico\n [2]>Hacker\n",
  *x_req_class_ex = " [3]>Monstruo\n",
  *x_req_add_or_start = "\e[1;33m¿Qué deseas hacer?\n \e[0m[1]>Agregar un cliente\n [2]>Iniciar partida\n",
  *x_member_joined = "Se conectó un jugador \n",
  *x_member_nameclass = "El jugador %d se quedó con nombre %s y clase %s\n",
  *x_start_game = "\e[1;33mIniciando Partida...\n",
